...
<html lang="zh-CN">
  ...
  <body>
    ...
    <nav class="navbar navbar-default">
      ...
      @endif
      <form class="form-signin" action="{{url('/dicechouqian')}}" method="post">
      <input type="hidden" name="_token" value="<?php echo csrf_token(); ?>">
      <input type="hidden" name="match" value="10">
      <h2 class="form-signin-heading">测量之星大赛抽签</h2>
      
      <button id="jgzjbutton" class="btn btn-lg btn-primary btn-block" type="submit">开始抽签</button>
    </form>
