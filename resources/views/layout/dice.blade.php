...
<html lang="zh-CN">
  ...
  <body>
    ...
    <nav class="navbar navbar-default">
      ...
      @endif
      <form class="form-signin" action="{{url('/dice')}}" method="post">
      <input type="hidden" name="_token" value="<?php echo csrf_token(); ?>">
      <input type="hidden" name="match" value="9">
      <h2 class="form-signin-heading">测量之星大赛报名</h2>
      ...
      <label for="inputEmail" class="sr-only">队员3学号</label>
      <input type="text" id="inputusenumber" name="peoplethree" class="form-control" placeholder="队员3学号" required autofocus>
      <br>
